...
{
    public class AddObjectTypeViewModel : BaseViewModel
    {
        private ObjectTypeModel ObjectType;
        private ObjectService ObjectService;   

        public AddObjectTypeViewModel()
        {
            this.ObjectType = new ObjectTypeModel();
        ...
        {
            var response = this.ObjectService.AddObjectType( this.ObjectType );
