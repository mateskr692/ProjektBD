...
{
    public class FinishRequestViewModel : BaseViewModel
    {
        private RequestService RequestService;
        private RequestModel RequestModel;

        public FinishRequestViewModel(RequestModel requestModel)
        {
        ...
        {
            var response = this.RequestService.FinishRequest( this.RequestModel.Id, this.RequestModel.Result );
