...
{
    public class AddClientObjectViewModel : BaseViewModel
    {
        private ObjectService ObjectService;
        private ObjectModel objectModel;
        private ObjectTypeModel objectTypeModel;

        public AddClientObjectViewModel( ClientModel clientModel )
        {
            this.ObjectService = new ObjectService();
            this.objectModel = new ObjectModel();
            this.objectModel.ClientId = clientModel.Id;
        ...
        {
            var response = this.ObjectService.AddClientObject( this.objectModel );
