...
{
    public class FinishRequestActivityViewModel : BaseViewModel
    {
        private ActivityService ActivityService;
        private ActivityModel ActivityModel;

        public FinishRequestActivityViewModel( ActivityModel activityModel )
        {
        ...
        {
            var response = this.ActivityService.FinishActivity( this.ActivityModel.Id, this.ActivityModel.Result );
